    ...
    <Carousel showArrows={false} showThumbs={false}>
      <div className={styles["testimonialsCard"]}>
        ...
        <p>
          ...
          dolorem vel distinctio eius esse possimus iusto unde quam neque
          voluptatem sunt asperiores, impedit facere odio nam eligendi sint
          deleniti fugit id soluta dicta. Labore, ut repellendus?
        </p>
      </div>
